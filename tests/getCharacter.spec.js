...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Verifica se a ffunção retorna o objeto correto para o parâmetro Brienne.', () => {
  ...
  it('Verifica se a ffunção retorna o objeto correto para o parâmetro Melissandre.', () => {
  ...
  it('Verifica se se o parâmetro não é Case Sensitive.', () => {
    expect(getCharacter('ARYA')).toEqual({
      name: 'Arya Stark',
      class: 'Rogue',
      phrases: [ 'Not today', 'A girl has no name.' ]
  ...
  it('Verifica se ao passar um nome que não está na tabela, a função retorna undefined.', () => {
    expect(getCharacter('keyla')).toBeUndefined();
  })
});
